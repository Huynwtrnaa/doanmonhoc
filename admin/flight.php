...
<div class="container mt-0">
  <div class="row">
    ...
    ?><!-- log on to codeastro.com for more projects -->
      ...
      <h1 class="text-secondary text-center">THÊM CHI TIẾT CHUYẾN BAY</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">CHUYẾN ĐI</h5>
          </div>
        ...
        <div class="form-row mb-4">
        <div class="col-md-3 ">
            <h5 class="form-name mb-0">CHUYẾN ĐẾN</h5>
          </div>          
          <div class="col">
        ...
        <div class="form-row">
          <div class="col">
            <div class="input-group">
                <label for="dura">Ước lượng</label>
        ...
        <button name="flight_but" type="submit" 
          ...
          <i class="fa fa-lg fa-arrow-right"></i> Xác nhận
          </div>
        </button>
      </form>
    </div>
