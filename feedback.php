...
<div class="container mb-4">
  <h1> <i class="far fa-comment-alt"></i> PHẢN HỒI</h1>
      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Ấn tượng đầu tiên của bạn khi vào trang web là gì?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option selected disabled>Bạn đã nghe về chúng tôi lần đầu từ đâu?</option>
                <option >Công cụ tìm kiếm</option>
                <option >Mạng xã hội</option>
                <option >Bạn bè/Người thân</option>
                <option >Lời truyền miệng</option>
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Có điều gì còn thiếu trên trang này không?</label>     
